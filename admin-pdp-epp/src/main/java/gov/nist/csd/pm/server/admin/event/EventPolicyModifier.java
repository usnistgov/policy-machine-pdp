...
import gov.nist.csd.pm.pap.op.graph.proto.*;
import gov.nist.csd.pm.pap.op.obligation.proto.CreateObligationOp;
import gov.nist.csd.pm.pap.op.obligation.proto.DeleteObligationOp;
import gov.nist.csd.pm.pap.op.operation.proto.CreateAdminOperationOp;
import gov.nist.csd.pm.pap.op.operation.proto.DeleteAdminOperationOp;
import gov.nist.csd.pm.pap.op.operation.proto.SetResourceOperationsOp;
import gov.nist.csd.pm.pap.op.prohibition.proto.CreateProhibitionOp;
import gov.nist.csd.pm.pap.op.prohibition.proto.DeleteProhibitionOp;
import gov.nist.csd.pm.pap.op.routine.proto.CreateAdminRoutineOp;
import gov.nist.csd.pm.pap.op.routine.proto.DeleteAdminRoutineOp;

...
import gov.nist.csd.pm.pdp.query.*;
import gov.nist.csd.pm.server.shared.protobuf.ProtoUtil;
	...
	class GetAscendantSubgraphTests {
		...
		void shouldReturnSingleNodeSubgraph() throws PMException {
			GetSubgraphQuery request = GetSubgraphQuery.newBuilder()
					.setNodeId(1)
					.build();
			var node = mock(gov.nist.csd.pm.common.graph.node.Node.class);
		...
		void shouldReturnNestedSubgraph() throws PMException {
			GetSubgraphQuery request = GetSubgraphQuery.newBuilder()
					.setNodeId(1)
					.build();
			var parentNode = mock(gov.nist.csd.pm.common.graph.node.Node.class);
			var childNode = mock(gov.nist.csd.pm.common.graph.node.Node.class);
